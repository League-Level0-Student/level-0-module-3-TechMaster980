//1. Create a new Processing sketch and import the minim library.

//2. Copy the following code into the sketch:
...
AudioSample doh;
AudioSample woohoo;
//3. Find a really hard Where's Waldo picture like this one: 
